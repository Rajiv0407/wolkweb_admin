...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
            ...
            ajax: {
                      url: '<?php echo URL::asset('postComments_datatable/'.$postId.'/'.$type); ?>',
                    },
             columns : [
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/postManagement/commentListing.blade.php ENDPATH**/ ?>