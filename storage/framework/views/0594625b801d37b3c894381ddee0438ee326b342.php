...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
            ...
            ajax: {
                      url: '<?php echo URL::asset('userHost_datatable/'.$userId.'/'.$type); ?>',
                    },
             columns : [
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/customerManagement/hostListing.blade.php ENDPATH**/ ?>