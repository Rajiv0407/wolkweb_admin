...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [ 
            ...
            ajax: {
                      url: '<?php echo URL::asset('userPointDatatable'); ?>',
                    },
             columns : [
                       { data: 'id'},
                        { data: 'name'},
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/userSocialManagement/index.blade.php ENDPATH**/ ?>