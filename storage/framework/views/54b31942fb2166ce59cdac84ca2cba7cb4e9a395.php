            ...
            <div class="carManagement__wrapper">
                <div class="breadcrumbWrapper">
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#customer_management" onclick="customerManagement()">Customer Management</a></li>
                ...
                <div class="carDetail__wrapper">
                    <div class="cd_if_1 filterWrapper">
                        <div>
                        <?php if($appImg!=''): ?>:
                            <img src="<?php echo e($imgPath_); ?>" alt="">
                            <?php else: ?>
                            <img src="<?php echo e(URL::to('/')); ?>/public/admin/images/avtar_i.png" alt="">
                            <?php endif; ?> 
                        </div>
                ...
                <div class="c_Doc c_dtl">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="Details-tab" data-bs-toggle="tab" data-bs-target="#Details" type="button" role="tab" aria-controls="Details" aria-selected="true" onclick="userHostListing('<?php echo e($userId); ?>',2,'Details')">Host</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="Advertisement-tab" data-bs-toggle="tab" data-bs-target="#Advertisement" type="button" role="tab" aria-controls="Advertisement" aria-selected="true" onclick="userHostListing('<?php echo e($userId); ?>',3,'Advertisement')" >Advertisement</button>
                        </li>   
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="followers-tab" data-bs-toggle="tab" data-bs-target="#followers" type="button" role="tab" aria-controls="followers" aria-selected="true" onclick="userHostListing('<?php echo e($userId); ?>',1,'followers')" >Followers</button>
                        </li>  
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="follows-tab" data-bs-toggle="tab" data-bs-target="#follows" type="button" role="tab" aria-controls="follows" aria-selected="true" onclick="userHostListing('<?php echo e($userId); ?>',4,'follows')" >Follows</button>
                        </li>                       
                    </ul>
...
<?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/customerManagement/customerDetail.blade.php ENDPATH**/ ?>