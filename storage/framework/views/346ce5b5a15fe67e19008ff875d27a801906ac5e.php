 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
            ...
            },
            {
                            ...
                            }else if(full['isAccepts_']==2){
                              className='inactiveNFor' ;
                            }else{
                              className='' ;
                            }

                            action+='<span class="'+className+'">'+full['isAccepts']+'</span>';
            ...
            ajax: {
                      url: '<?php echo URL::asset('userFollower_datatable/'.$userId.'/'.$type); ?>',
                    },
             columns : [
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/customerManagement/followers.blade.php ENDPATH**/ ?>