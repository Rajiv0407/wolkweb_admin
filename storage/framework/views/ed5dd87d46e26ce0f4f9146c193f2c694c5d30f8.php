<div class="carManagement__wrapper">
                <div class="breadcrumbWrapper d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                        <h3 class="fs-5 m-0 fw-500">Subscriber</h3>
                        <ol class="breadcrumb">
...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [ 
            ...
            ajax: {
                      url: '<?php echo URL::asset('subscriberDatatable'); ?>',
                    },
             columns : [
...
function ConfirmDelete(id) {
    ...
    function delete_customer(id){
             ajaxCsrf();
        $.ajax({type:"POST",
        url:baseUrl+'/subscriptionDelete',    
        data:{"id":id},
        dataType:'json',
        beforeSend:function()
        {
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/subscriptions/index.blade.php ENDPATH**/ ?>