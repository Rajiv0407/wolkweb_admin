            ...
            <div class="carManagement__wrapper">
                ...
                <div class="c_Doc c_dtl">
                    ...
                    <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="post_file-tab" data-bs-toggle="tab" data-bs-target="#post_file" type="button" role="tab" aria-controls="postFile" aria-selected="true" onclick="commentListing('<?php echo e($postId); ?>',4,'post_file')" >File(Image/Audio/Video)</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="Details-tab" data-bs-toggle="tab" data-bs-target="#Details" type="button" role="tab" aria-controls="Details" aria-selected="true" onclick="commentListing('<?php echo e($postId); ?>',2,'Details')">Comment</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="post_like-tab" data-bs-toggle="tab" data-bs-target="#post_like" type="button" role="tab" aria-controls="likes" aria-selected="true" onclick="commentListing('<?php echo e($postId); ?>',1,'post_like')">Like</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="post_share-tab" data-bs-toggle="tab" data-bs-target="#post_share" type="button" role="tab" aria-controls="share" aria-selected="true" onclick="commentListing('<?php echo e($postId); ?>',3,'post_share')" >Share</button>
                        </li>
                    </ul>
...
<?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/postManagement/postDetail.blade.php ENDPATH**/ ?>