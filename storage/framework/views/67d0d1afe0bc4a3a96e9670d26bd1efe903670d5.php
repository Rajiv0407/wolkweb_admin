                ...
                <div class="breadcrumbWrapper">
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#notification" onclick="notificationList()">Notification</a></li>
            ...
            <div class="form-group mb-3">
               ...
               <?php endif  ?>
                        ...
                        <div class="flare_btn__group d-flex max-w-250">
                            <a href="javascript:void(0);" class="search-btn">Send</a>
                            <a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#notification" onclick="notificationList()" class="search-btn clear-btn ml-5px">Clear</a>
                        </div>
                    </div>
                </form>
...
<?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/notification/notificationDetail.blade.php ENDPATH**/ ?>