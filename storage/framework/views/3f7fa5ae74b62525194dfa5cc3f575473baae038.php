    ...
    <div class="form modal-form">
        <div class="form-group">
            <label for="Manufacture">Title</label>
             <input type="text" name="editSTitle" id="editSTitle"  value="<?php echo isset($nFor->title)?$nFor->title:'' ; ?>" class="form-control" placeholder="Title">
...
</form><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/master/notificationTitle/editNFor.blade.php ENDPATH**/ ?>