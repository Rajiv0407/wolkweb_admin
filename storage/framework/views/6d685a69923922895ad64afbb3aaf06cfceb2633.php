...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
            ...
            ajax: {
                      url: '<?php echo URL::asset('post_file_datatable/'.$postId.'/'.$type); ?>',
                    },
             columns : [
...
</script><?php /**PATH D:\xampp\htdocs\walkofwebAdmin\walkofweb_admin\resources\views/admin/postManagement/postFileListing.blade.php ENDPATH**/ ?>