...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
                    ...
                    "mRender": function(data, type, full){
                        var response ='' ;
                        if(full['House_Number']!='' && full['House_Number']!=null){
                            response+=full['House_Number'] ;
                        }

                        if(full['LandMark']!='' && full['LandMark']!=null){
                            response+=','+full['LandMark'] ;
                        }

                        if(full['City']!='' && full['City']!=null){
                            response+=','+full['City'] ;
                        }
                        if(full['Zipcode']!='' && full['Zipcode']!=null){
                            response+='-'+full['Zipcode'] ;
                        }
                        if(full['State']!='' && full['State']!=null){
                            response+=','+full['State'] ;
                        }
                        if(full['Country']!='' && full['Country']!=null){
                            response+=','+full['Country'] ;
                        }
                        return response ;
                    }
                }
